...
/** Discovery & customer actions data (from GBP API after auth). When absent, values show as blank. */
export interface GBPDiscoveryAndActions {
  discovery?: {
...
function formatDiscoveryValue(value: number | null | undefined): string {
  if (value == null || Number.isNaN(value)) return BLANK_VALUE;
  return typeof value === "number" ? String(value) : BLANK_VALUE;
}
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Key performance indicators for your Google Business Profile. Tap a card for details and improvement tips.
          </p>
        </div>
        <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 overflow-x-auto md:overflow-x-visible pb-4 md:pb-0 px-1 md:px-0 scrollbar-hide">
        <Card
